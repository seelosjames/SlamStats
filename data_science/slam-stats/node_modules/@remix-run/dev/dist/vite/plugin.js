...
var serverEntryId = require('./server-entry-id.js');
...
let vmods = [serverEntryId.serverEntryId, serverManifestId, browserManifestId];
...
const remixVitePlugin = (options = {}) => {
  ...
  let resolvePluginConfig = async () => {
    var _options$future, _options$future2;
    let defaults = {
    ...
    return {
      ...
      future: {
        ...
        v3_relativeSplatPath: ((_options$future2 = options.future) === null || _options$future2 === void 0 ? void 0 : _options$future2.v3_relativeSplatPath) === true
      }
    };
  };
  ...
  return [{
          ...
          build: {
            ...
            ...(!isSsrBuild ? {
              ...
              rollupOptions: {
                ...
                preserveEntrySignatures: "exports-only",
                input: serverEntryId.serverEntryId,
                output: {
    ...
    configureServer(viteDevServer) {
      var _viteDevServer$httpSe;
      (_viteDevServer$httpSe = viteDevServer.httpServer) === null || _viteDevServer$httpSe === void 0 ? void 0 : _viteDevServer$httpSe.on("listening", () => {
      ...
      return () => {
        ...
        if (!viteDevServer.config.server.middlewareMode) {
          viteDevServer.middlewares.use(async (req, res, next) => {
            try {
              let build = await viteDevServer.ssrLoadModule(serverEntryId.serverEntryId);
    ...
    async load(id) {
      switch (id) {
        case vmod.resolve(serverEntryId.serverEntryId):
          {
    ...
    async transform(code, id, options) {
      ...
      if (clientFileRE.test(id) || clientDirRE.test(id)) {
        ...
        return {
          code: exports.map(({
            n: name
          }) => name === "default" ? "export default {};" : `export const ${name} = {};`).join("\n"),
          map: null
        };
      }
    }
